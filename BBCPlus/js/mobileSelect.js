/*
 * @Author: zk.zhouyf
 * @Date: 2023-08-17 16:08:46
 * @LastEditors: zk.zhouyf
 * @LastEditTime: 2023-08-17 16:46:32
 * @FilePath: \BBCPlus\BBCPlus\js\mobileSelect.js
 * @Description: 
 * 
...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			if(!_this.trigger){
				console.log('mobileSelect has been successfully installed, but no trigger found on your page.');
				return false;
			}
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText){
			var _this = this;
			var cancelText = cancelBtnText ? cancelBtnText : '重置';
		...
		updateWheel: function(sliderIndex, data){
			...
			var tempHTML='';
	    	if(_this.cascade){
	    		console.log('级联格式不支持updateWheel(),请使用updateWheels()更新整个数据源');
				return false;
	    	}
